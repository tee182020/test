...
members_count is set to be zero<br />
loop while the input of member name is not empty<br />
'''Python    increment members_count by one<br />
...
for example, a flowchart of counting members is as follows:<br />
     ...
     |                 V                                  |<br />
     |    -------------------------------------------     |<br />
     ----|   increment members_count by one |     |<br />
         --------------------------------------------     |<br />
                                                          |<br />
                                                          |<br />
                                                          V<br />
         ---------------------------------------------------------<br />
         |  output members_count                                 |<br />
         ---------------------------------------------------------<br />
